...
function BottomNav({ navigation }) {
  ...
  const t = useT()
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 lg:hidden border-t border-white/[0.06] bg-[#09101f]/95 backdrop-blur-xl" style={{ paddingBottom: 'env(safe-area-inset-bottom)', height: 'calc(64px + env(safe-area-inset-bottom))' }}>
...
export function DashboardLayout({ navigation, title }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#050a14] lg:flex">
      ...
      <div className="flex flex-1 min-w-0 flex-col pb-[calc(68px+env(safe-area-inset-bottom))] lg:pb-0">
