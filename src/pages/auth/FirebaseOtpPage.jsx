        ...
        <div>
          ...
          {botLink && (
            <a
              ...
              className="mt-2 flex items-center gap-2 rounded-xl px-4 py-3 text-[13px] font-semibold text-white transition-all"
              style={{ background: 'linear-gradient(135deg,#0088cc,#0066aa)', boxShadow: '0 4px 16px rgba(0,136,204,0.3)' }}
            >
              <svg viewBox="0 0 24 24" className="h-5 w-5 shrink-0 fill-white"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.447 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.333-.373-.12l-6.871 4.326-2.962-.924c-.643-.204-.657-.643.136-.953l11.57-4.461c.537-.194 1.006.131.833.941z"/></svg>
              Telegram botni ulang — OTP bot orqali keladi
            </a>
          )}
        </div>
